...
- Hedge: ultimate_hedge_bot/core/main.py (or bots/jitter/hybrid.py)
...
⚠️  NOTE: For advanced features (health monitoring, auto-restart, metrics),
   use the advanced orchestrator: python orchestrator/master.py
"""
...
def resolve_entries() -> Dict[str, Path]:
    ...
    mapping: Dict[str, List[str]] = {
        ...
        # Hedge
        "hedge": [
            "ultimate_hedge_bot/core/main.py",
