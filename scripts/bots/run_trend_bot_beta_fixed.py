#!/usr/bin/env python3
"""
Trend Bot - Beta.Drift.Trade Runner (Fixed Version)
Runs the trend bot on beta.drift.trade (devnet) with enhanced tracking
Fixed: Unicode errors, OrderManager issues, and price data
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('trend_bot_beta_tracking.log', encoding='utf-8'),
